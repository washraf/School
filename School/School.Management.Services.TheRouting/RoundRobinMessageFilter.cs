...
namespace School.Management.Services.TheRouting
{
    public class RoundRobinMessageFilter : MessageFilter
    {
        ...
        private void SetGroup(RoundRobinGroup group)
        {
            if (group == null)
            {
        ...
        {
            private string name;
            private List<RoundRobinMessageFilter> filters = new List<RoundRobinMessageFilter>();
            private IEnumerator<RoundRobinMessageFilter> currentPosition;
        ...
        private class RoundRobinMessageFilterTable<TFilterData> : IMessageFilterTable<TFilterData>
        {
            private Dictionary<MessageFilter, TFilterData> filters = new Dictionary<MessageFilter, TFilterData>();
            private Dictionary<string, RoundRobinGroup> groups = new Dictionary<string, RoundRobinGroup>();
